...
Turn any generic smart plug into an advanced Electric Vehicle charger directly from Home Assistant.

Specially designed for motorcycles or cars without internet connectivity (API), this integration dynamically calculates the real injected kWh to protect your battery by cutting off the power at exactly **80%**.
...
Convierte cualquier enchufe inteligente genérico en un cargador de vehículos eléctricos avanzado directamente desde Home Assistant.

Especialmente diseñado para motos o coches sin conectividad a internet, esta integración calcula dinámicamente los kWh reales inyectados para proteger tu batería cortando la corriente exactamente al **80%**.
